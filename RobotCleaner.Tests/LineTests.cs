...
namespace RobotCleaner.Tests
{
    public class LineTests
    {
        ...
        public void IsVertical_VerticalLines_ReturnTrue(int startX, int startY, int endX, int endY)
        {
        ...
        public void GetIntersections_MultipleOverlaps_ReturnTrue(int line1StartX, int line1StartY, int line1EndX, int line1EndY,
